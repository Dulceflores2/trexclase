...
function setup() {
  ...
  // adaptar el canvas a la altura y anchura de la pantalla
  createCanvas(windowWidth, windowHeight);
  
  // adaptar la creaccion de los sprites con relacion a tamañode la pantalla
...
function draw() {
  ...
  if (gameState===PLAY){
    ...
    //configurar el salto del trex al hacer touching en el celular
